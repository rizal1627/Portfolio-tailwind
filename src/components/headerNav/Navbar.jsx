...
const Navbar = () => {
    ...
    return (
        <>
            <div className="Header_Main flex flex-col shadow-lg bg-slate-900 text-slate-100 fixed z-10 w-full md:hidden xss:hidden lg:flex xl:flex">
                <div className="Nav__ flex md:flex-row md:-mt-0 xss:flex-col gap-2">
                    <div className="Logo__ basis-1/4 flex xss:justify-center md:justify-start xl:w-full xss:w-full p-4">
                        <a className="" href="/">
                            <img className=" xl:h-12 lg:h-12 md:h-12 sm:h-12 xss:h-12 " alt="logo" src={Logo}></img>
                        </a>
                    </div>
                    <div className="MenuLink__ flex flex-col xss:justify-center xss:items-center md:justify-center md:items-start xl:w-full font-sans text-lg font-bold xss:p-2 md:p-2">
                        <ul className="flex">
                            ...
                            <li><a className="p-4 hover:bg-clip-text hover:text-transparent hover:bg-gradient-to-r hover:from-pink-500 hover:to-violet-500 transition delay-150 ease-in-out" href="#contact">Contact</a></li>
                        </ul>
                    </div>
